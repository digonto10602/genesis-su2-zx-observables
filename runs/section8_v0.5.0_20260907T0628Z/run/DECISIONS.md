...
D-E (campaign v0.6.2 R12): v0.5.0 twin repeats were seeded seed + k and overlap in N-1 of N shots under Aer's per-shot seeding; every v0.5.0 twin sigma is void; no v0.5.0 twin number was ever gated. Mechanism evidence: runs/campaign_v060/sessions/c060_p0_20260909_5/seed-mechanism.json. The archived v0.4.0 package was grepped for the same pattern and does not carry it (runs/campaign_v060/sessions/c060_p0_20260909_5/v040-seed-pattern-finding.md).
